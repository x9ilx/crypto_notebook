...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('SALE', 'PURCHASE', name='transactiontype'), nullable=False),
    ...
    op.create_table('riskminimisation',
    sa.Column('price', sa.Float(), nullable=False),
    ...
    with op.batch_alter_table('riskminimisation', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_riskminimisation_id'), ['id'], unique=False)
